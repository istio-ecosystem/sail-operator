...
require (
	...
	istio.io/client-go v1.30.0-alpha.1.0.20260609170344-d1c5bc3c0f30
	istio.io/istio v0.0.0-20260610005536-fcc63ab39c7e
	k8s.io/api v0.36.1
...
require (
	...
	istio.io/api v1.30.0-alpha.1.0.20260609165738-daad7dbd1f94 // indirect
