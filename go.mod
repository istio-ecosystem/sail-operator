...
require (
	...
	istio.io/client-go v1.31.0-alpha.0.0.20260721120332-962757d10c8c
	istio.io/istio v0.0.0-20260722211934-6bdf0e0b2bdb
	k8s.io/api v0.36.3
...
require (
	...
	istio.io/api v1.30.0-alpha.1.0.20260721115833-b8f8791d9653 // indirect
