...
require (
	...
	istio.io/client-go v1.23.0-alpha.0
	istio.io/istio v0.0.0-20240712200811-9bcbb2349ce8
	k8s.io/api v0.30.1
...
require (
	...
	istio.io/api v1.22.0-alpha.1.0.20240710015323-7bf1eab280a7 // indirect
