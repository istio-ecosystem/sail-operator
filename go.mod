...
require (
	...
	istio.io/client-go v1.29.0-alpha.0.0.20260121180928-8a76f0b496fd
	istio.io/istio v0.0.0-20260122004028-702493a17f1b
	k8s.io/api v0.35.0
...
require (
	...
	istio.io/api v1.29.0-alpha.0.0.20260121180630-6caf94532f72 // indirect
