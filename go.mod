...
require (
	...
	istio.io/client-go v1.30.0-alpha.1.0.20260415171853-f031048e9136
	istio.io/istio v0.0.0-20260416171755-ecbddd9f5932
	k8s.io/api v0.35.3
...
require (
	...
	istio.io/api v1.30.0-alpha.1.0.20260415171154-7fa57afdea51 // indirect
