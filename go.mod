...
require (
	...
	istio.io/client-go v1.31.0-alpha.1.0.20260820184552-ec828dea7ad7
	istio.io/istio v0.0.0-20260821181226-527f8d6cb12e
	k8s.io/api v0.36.4
...
require (
	...
	istio.io/api v1.31.0-alpha.1.0.20260820183952-a9606a531081 // indirect
