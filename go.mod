...
require (
	...
	istio.io/client-go v1.28.0-alpha.0.0.20251217173025-01b4f94b2b6e
	istio.io/istio v0.0.0-20251218043625-d8f0973a0a13
	k8s.io/api v0.34.1
...
require (
	...
	istio.io/api v1.28.0-alpha.0.0.20251217172525-936149f9e310 // indirect
