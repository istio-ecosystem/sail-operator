...
require (
	...
	istio.io/client-go v1.30.0-alpha.1.0.20260411030659-320d16e1b01e
	istio.io/istio v0.0.0-20260415144719-3f6f77b34074
	k8s.io/api v0.35.3
...
require (
	...
	istio.io/api v1.29.0-alpha.0.0.20260411030259-92fcfbea281b // indirect
