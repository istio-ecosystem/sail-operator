...
require (
	...
	istio.io/client-go v1.26.0-alpha.0.0.20250715152539-522e9498d2b9
	istio.io/istio v0.0.0-20250716002037-eecced083b64
	k8s.io/api v0.33.3
...
require (
	...
	istio.io/api v1.26.0-alpha.0.0.20250715152038-7c1a7c944192 // indirect
