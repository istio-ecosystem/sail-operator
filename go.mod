...
require (
	...
	istio.io/client-go v1.23.0-alpha.0.0.20240726212632-fa8d871339b5
	istio.io/istio v0.0.0-20240726222432-52c9097444fc
	k8s.io/api v0.30.3
...
require (
	...
	istio.io/api v1.23.0-alpha.0.0.20240726212339-325839bcae56 // indirect
