...
require (
	...
	istio.io/client-go v1.22.0-alpha.1.0.20240704061608-a9e964db9f67
	istio.io/istio v0.0.0-20240704163717-363587c58282
	k8s.io/api v0.30.1
...
require (
	...
	istio.io/api v1.22.0-alpha.1.0.20240704061010-970065be2138 // indirect
