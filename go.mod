...
require (
	...
	istio.io/client-go v1.23.0-alpha.0.0.20241008225844-395a48e49cd4
	istio.io/istio v0.0.0-20241010021245-216aec97fa5b
	k8s.io/api v0.31.1
...
require (
	...
	istio.io/api v1.23.0-alpha.0.0.20241008225447-9e245289297e // indirect
