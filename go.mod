...
require (
	...
	istio.io/client-go v1.31.0-alpha.1.0.20260813140707-3a2d7266056f
	istio.io/istio v0.0.0-20260814221810-8dc789c5cf17
	k8s.io/api v0.36.3
...
require (
	...
	istio.io/api v1.31.0-alpha.1.0.20260813140406-abc03d0ea7f3 // indirect
