...
require (
	...
	istio.io/client-go v1.26.0-alpha.0.0.20250717165943-05dcf8c8b925
	istio.io/istio v0.0.0-20250719002143-4b505ec0ef4a
	k8s.io/api v0.33.3
...
require (
	...
	istio.io/api v1.26.0-alpha.0.0.20250717165143-4f1ba257a225 // indirect
