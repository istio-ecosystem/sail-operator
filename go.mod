...
require (
	...
	istio.io/client-go v1.24.0-alpha.0.0.20241018025852-180069d05abc
	istio.io/istio v0.0.0-20241018033452-d643c2b4db75
	k8s.io/api v0.31.1
...
require (
	...
	istio.io/api v1.24.0-alpha.0.0.20241018025552-585d68d196b9 // indirect
