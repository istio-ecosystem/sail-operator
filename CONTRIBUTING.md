...
If you want to add new documentation or examples to our existing documentation please take a look at the [documentation guidelines](https://github.com/istio-ecosystem/sail-operator/docs/guidelines/guidelines.md) to help you get started. Take into account that we run automation test over the documentation examples, so please ensure that the examples are correct and follows the guidelines to ensure it will be properly tested.
