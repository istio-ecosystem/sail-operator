...
// +kubebuilder:rbac:groups=sail-operator.io,resources=istios,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sail-operator.io,resources=istios/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=sail-operator.io,resources=istios/finalizers,verbs=update
