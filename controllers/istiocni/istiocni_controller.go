...
// +kubebuilder:rbac:groups=sail-operator.io,resources=istiocnis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sail-operator.io,resources=istiocnis/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=sail-operator.io,resources=istiocnis/finalizers,verbs=update
