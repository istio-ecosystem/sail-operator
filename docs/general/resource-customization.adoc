...
* **Integration Test**: `tests/integration/api/istiorevision_test.go`
* **Documentation**: This annotation was introduced in commit https://github.com/istio-ecosystem/sail-operator/commit/2543fb8[2543fb8]
