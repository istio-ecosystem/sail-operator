...
Because the CNI component runs as a cluster singleton, it is recommended to operate and upgrade the CNI component seperately from the Istio control plane.
