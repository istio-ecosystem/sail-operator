...
2. Test traffic distribution (e.g., for Bookinfo reviews service):
...
1. Check AuthorizationPolicy resources:
...
2. Test policy enforcement (e.g., deny access from a specific source):
