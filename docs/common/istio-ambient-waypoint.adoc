...
:istio_latest_version: 1.28.2
:istio_latest_version_revision_format: 1-28-2
:istio_latest_tag: v1.28-latest
:istio_release_name: release-1.28
:istio_latest_minus_one_version: 1.28.1
:istio_latest_minus_one_version_revision_format: 1-28-1
...
waypoint-5d9c8b7f9-abc12.bookinfo     SYNCED     SYNCED     SYNCED     SYNCED     istiod-6cf8d4f9cb-wm7x6.istio-system     {istio_latest_version}
----
...
----
$ istioctl proxy-status | grep waypoint
waypoint-5d9c8b7f9-abc12.bookinfo     SYNCED     SYNCED     SYNCED     SYNCED     istiod-{istio_latest_version_revision_format}-7b9f8c5d6-xyz78.istio-system     {istio_latest_version}
----

The output shows the waypoint proxy connected to the revision-specific istiod pod (note the revision `{istio_latest_version_revision_format}` in the pod name) and running the updated version.
