...
// Test block removed - now part of comprehensive e2e test
...
// Comprehensive E2E test for ambient waypoint proxy
// This test includes all prerequisites, setup, testing, and cleanup
ifdef::ambient-waypoint-e2e[]
echo "======================================"
echo "Starting Ambient Waypoint E2E Test"
echo "======================================"
...
kubectl label namespace istio-system istio-discovery=enabled --overwrite
...
with_retries kubectl get istio default -o jsonpath='{.status.state}' | grep -q "Healthy"
...
with_retries kubectl get ztunnel default -o jsonpath='{.status.state}' | grep -q "Healthy"

# Deploy bookinfo application
echo "Deploying bookinfo application..."
kubectl create ns bookinfo --dry-run=client -o yaml | kubectl apply -f -
kubectl label namespace bookinfo istio-discovery=enabled --overwrite
...
echo "Waiting for bookinfo pods to be ready..."
with_retries wait_pods_ready_by_ns "bookinfo"

# Add bookinfo to ambient mesh
echo "Adding bookinfo to ambient mesh..."
kubectl label namespace bookinfo istio.io/dataplane-mode=ambient --overwrite

# ============================================
# PHASE 2: Waypoint Proxy Testing
# ============================================
echo "Phase 2: Testing waypoint proxy..."
...
# Enroll namespace to use waypoint
echo "Enrolling bookinfo namespace to use waypoint..."
...
# Verify waypoint proxy is running
echo "Verifying waypoint proxy..."
kubectl get pods -n bookinfo -l gateway.networking.k8s.io/gateway-name=waypoint
istioctl proxy-status | grep waypoint || echo "Waypoint proxy status checked"

# ============================================
# PHASE 3: L7 Features Testing
# ============================================
echo "Phase 3: Testing L7 features..."

# Deploy curl service for testing
echo "Deploying curl service..."
...
# Apply HTTPRoute for traffic routing
...
# Remove Istio and Gateway resources
echo "Removing Istio and Gateway resources..."
...
# Remove bookinfo applications
echo "Removing bookinfo applications..."
...
kubectl delete ztunnel default --ignore-not-found=true
kubectl delete istiocni default --ignore-not-found=true
kubectl delete istio default --ignore-not-found=true
...
echo "======================================"
echo "Ambient Waypoint E2E Test Completed"
echo "======================================"
endif::[]
