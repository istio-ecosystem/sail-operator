...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `version` _string_ | Defines the version of Istio to install. Must be one of: v1.25-latest, v1.25.1, v1.24-latest, v1.24.4, v1.24.3, v1.24.2, v1.24.1, v1.24.0. | v1.25.1 | Enum: [v1.25-latest v1.25.1 v1.24-latest v1.24.4 v1.24.3 v1.24.2 v1.24.1 v1.24.0]   |
