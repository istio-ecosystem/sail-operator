...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `version` _string_ | Defines the version of Istio to install. Must be one of: v1.6-latest, v1.26.2, v1.24-latest, v1.24.6, v1.24.5, v1.24.4, v1.24.3. | v1.26.2 | Enum: [v1.6-latest v1.26.2 v1.24-latest v1.24.6 v1.24.5 v1.24.4 v1.24.3]   |
