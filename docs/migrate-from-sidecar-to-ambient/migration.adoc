...
kubectl get namespace istio-cni 2>/dev/null || kubectl create namespace istio-cni
...
kubectl get namespace ztunnel 2>/dev/null || kubectl create namespace ztunnel
