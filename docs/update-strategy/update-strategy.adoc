...
**For ambient mode:** Also update IstioCNI and ZTunnel components after the control plane. See link:../common/istio-ambient-update.adoc#updating-istio-in-ambient-mode[Updating Istio in Ambient Mode] for:

* IstioCNI updates
* ZTunnel updates
* Waypoint proxy updates
