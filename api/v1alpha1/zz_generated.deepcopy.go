...
func (in *RemoteIstioSpec) DeepCopyInto(out *RemoteIstioSpec) {
	*out = *in
	if in.UpdateStrategy != nil {
		in, out := &in.UpdateStrategy, &out.UpdateStrategy
		*out = new(RemoteIstioUpdateStrategy)
		(*in).DeepCopyInto(*out)
	}
	if in.Values != nil {
		in, out := &in.Values, &out.Values
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteIstioUpdateStrategy) DeepCopyInto(out *RemoteIstioUpdateStrategy) {
	*out = *in
	if in.InactiveRevisionDeletionGracePeriodSeconds != nil {
		in, out := &in.InactiveRevisionDeletionGracePeriodSeconds, &out.InactiveRevisionDeletionGracePeriodSeconds
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteIstioUpdateStrategy.
func (in *RemoteIstioUpdateStrategy) DeepCopy() *RemoteIstioUpdateStrategy {
	if in == nil {
		return nil
	}
	out := new(RemoteIstioUpdateStrategy)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteRevisionSummary) DeepCopyInto(out *RemoteRevisionSummary) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteRevisionSummary.
func (in *RemoteRevisionSummary) DeepCopy() *RemoteRevisionSummary {
	if in == nil {
		return nil
	}
	out := new(RemoteRevisionSummary)
	in.DeepCopyInto(out)
	return out
}
